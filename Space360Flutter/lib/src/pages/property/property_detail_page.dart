...
class _VehicleDetails extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return _Section(
      title: 'Ficha técnica',
      child: _Grid(rows: [
        if (property.brand != null) _Row('Marca', property.brand!),
        if (property.model != null) _Row('Modelo', property.model!),
        if (property.year != null) _Row('Año', property.year!),
        if (property.color != null) _Row('Color', property.color!),
        if (property.mileageKm != null) _Row('Kilometraje', '${property.mileageKm} km'),
        if (property.fuelType != null) _Row('Combustible', property.fuelType!),
        if (property.transmission != null) _Row('Transmisión', property.transmission!),
        if (property.engineCc != null) _Row('Motor', '${property.engineCc} cc'),
        if (property.doors != null) _Row('Puertas', property.doors!),
        if (property.passengers != null) _Row('Pasajeros', property.passengers!),
        if (property.condition != null) _Row('Condición', property.condition!),
        if (property.drivetrain != null) _Row('Tracción', property.drivetrain!),
      ]),
    );
  }
}
...
class _RealEstateDetails extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return _Section(
      ...
      child: _Grid(rows: [
        if (property.code != null) _Row('Código', property.code!),
        if (property.rooms != null) _Row('Habitaciones', property.rooms!),
        if (property.bathrooms != null) _Row('Baños', property.bathrooms!),
        if (property.garage != null) _Row('Parqueo', property.garage!),
        if (property.construction != null) _Row('Construcción', '${property.construction} m²'),
        if (property.land != null) _Row('Terreno', '${property.land} m²'),
        if (property.constructionYear != null) _Row('Año const.', property.constructionYear!),
        if (property.maintenance != null) _Row('Mantenimiento', property.maintenance!),
        if (property.address != null) _Row('Dirección', property.address!),
      ]),
    );
  }
}
