                    ...
                    <tbody>
                        @forelse($companies as $c)
                            <tr>
                                <td>
                                    @if ($c->logo)
                                        <img src="{{ route('file', $c->logo) }}" class="mr-2 rounded"
                                ...
                                <td>
                                    <div class="btn-group btn-group-sm">
                                        <a href="{{ route('admin.companies.show', $c) }}" class="btn btn-outline-info"
                                        ...
                                        <form action="{{ route('admin.companies.toggle-status', $c) }}" method="POST"
                                            ...
                                            @csrf
                                            <button
                                                class="btn btn-outline-{{ $c->status === 'active' ? 'warning' : 'success' }}"
