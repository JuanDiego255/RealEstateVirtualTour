...
<div class="crm-page">
    ...
    <div class="crm-page-header">
        <div>
            <h2><i class="fa fa-edit"></i> Editar: {{ $reward->name }}</h2>
            <div class="sub">Modifica los criterios y valor de la recompensa</div>
        </div>
        <div class="actions">
    ...
    <div style="max-width:680px;">
        <div class="dashboard-card">
            <div class="dc-header" style="background:linear-gradient(135deg,#c2ac1f,#a89617);">
                <h5 style="color:#fff;"><i class="fa fa-edit" style="color:#fff;"></i> Editar Recompensa</h5>
            </div>
            <div class="dc-body">
