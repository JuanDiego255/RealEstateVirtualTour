                ...
                <div class="card h-100 {{ !$prize->active || $exhausted ? 'border-secondary' : 'border-0 shadow-sm' }}"
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center mb-3">
                            <div style="width:48px;height:48px;border-radius:50%;background:{{ $prize->color }};
                        ...
                        @else
                            ...
                            <div class="d-flex justify-content-between mb-1">
                                <small class="text-muted">{{ $prize->claimed }} / {{ $prize->quantity }} entregados</small>
                            ...
                            @else
                                <small class="text-success"><i class="fas fa-check-circle"></i> {{ $prize->remaining }} disponibles</small>
                            @endif
                        @endif
                    </div>
                    ...
                    <div class="card-footer bg-transparent d-flex" style="gap:.4rem;">
                        ...
                        <form method="POST" action="{{ route('admin.raffle-prizes.reset', $prize) }}">
                            @csrf @method('PATCH')
                            <button type="submit" class="btn btn-sm btn-outline-warning" title="Reiniciar contador">
