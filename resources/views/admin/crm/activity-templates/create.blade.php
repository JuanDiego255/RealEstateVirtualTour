@extends('admin.main')
@section('title', 'Nueva Plantilla de Actividad')
@section('content')
...
<div class="crm-page">
    ...
    <div class="crm-page-header">
        <div>
            <h2><i class="fa fa-plus-circle"></i> Nueva Plantilla de Actividad</h2>
            <div class="sub">Crea una plantilla reutilizable para tus actividades</div>
        </div>
        <div class="actions">
    ...
    <form method="POST" action="{{ route('admin.crm.activity-templates.store') }}">
        @csrf
        ...
        <div class="dashboard-card" style="max-width:760px;">
                ...
                <div class="row mb-4">
                    <div class="col-md-6">
                        ...
                        <select name="type" class="form-control @error('type') is-invalid @enderror"
                            ...
                            <option value="call"     {{ old('type')=='call'?'selected':'' }}>📞 Llamada</option>
                            ...
                            <option value="note"     {{ old('type')=='note'?'selected':'' }}>📝 Nota</option>
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="stage" class="form-control @error('stage') is-invalid @enderror"
                            ...
                            <option value="new"         {{ old('stage')=='new'?'selected':'' }}>Nuevo</option>
                            <option value="contacted"   {{ old('stage')=='contacted'?'selected':'' }}>Contactado</option>
                            <option value="qualified"   {{ old('stage')=='qualified'?'selected':'' }}>Calificado</option>
                            ...
                            <option value="won"         {{ old('stage')=='won'?'selected':'' }}>Ganado</option>
                ...
                <div class="row align-items-center mb-2" style="margin-top:12px;">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" name="task_due_hours" value="{{ old('task_due_hours', 24) }}"
            ...
            <div style="padding:16px 24px; border-top:1px solid #f0f0f0; display:flex; gap:10px; justify-content:flex-end;">
                <a href="{{ route('admin.crm.activity-templates.index') }}" class="action-btn secondary">
                    Cancelar
                </a>
