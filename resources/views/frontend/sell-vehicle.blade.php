                        ...
                        <div class="sv-phone-mockup">
                            <div class="sv-phone-frame">
                                <div class="sv-phone-screen">
                                    ...
                                    <span style="color:rgba(255,255,255,.5);font-size:.8rem;letter-spacing:1px">TOUR
                                        VIRTUAL 360°</span>
                                    <div style="display:flex;gap:6px">
                                        <span
                                            style="width:6px;height:6px;border-radius:50%;background:#c2ac1f;animation:sv-pulse 1.4s infinite"></span>
                                        <span
                                            style="width:6px;height:6px;border-radius:50%;background:rgba(255,255,255,.3);animation:sv-pulse 1.4s infinite .3s"></span>
                                        <span
                                            style="width:6px;height:6px;border-radius:50%;background:rgba(255,255,255,.3);animation:sv-pulse 1.4s infinite .6s"></span>
                                    </div>
                                </div>
                            </div>
                        </div>
