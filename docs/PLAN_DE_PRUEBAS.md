...
- [x ] **0.2 Cron maestro** (para recordatorios y seguimientos)
...
- [x ] **1.2 Verificación del webhook**
...
- [x ] **2.1 Responde con catálogo real**
...
- [x ] **3.5 Relevo por palabra clave / nota de voz**
...
- [x ] **7.1 Reparte al menos cargado**
...
- [x ] **12.1** El panel de conversaciones (`admin/whatsapp`) sigue permitiendo tomar control / devolver al bot.
- [ ] **12.2** El CRM existente (leads, pipeline, agenda, reportes) sigue funcionando.
- [x ] **12.3** `php artisan schedule:list` no muestra errores.
- [x ] **12.4** Revisá `storage/logs/laravel.log` y el canal `whatsapp` sin excepciones nuevas.
